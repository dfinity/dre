...
import { idlFactory } from './node-provider-rewards.did.js';
export { idlFactory } from './node-provider-rewards.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NODE_PROVIDER_REWARDS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./node-provider-rewards.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the node-provider-rewards canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./node-provider-rewards.did.js")._SERVICE>}
 */
export const node_provider_rewards = createActor(canisterId);
