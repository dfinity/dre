...
import { idlFactory } from './npr.did.js';
export { idlFactory } from './npr.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NPR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./npr.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the npr canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./npr.did.js")._SERVICE>}
 */
export const npr = createActor(canisterId);
