                ...
                Action::ExecuteNnsFunction(a) => {
                    if a.payload.is_empty() {
                        ...
                        match a.nns_function() {
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::IcpXdrConversionRate => serde_json::to_value(
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::SetAuthorizedSubnetworks => serde_json::to_value(
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::UpdateNodeOperatorConfig => serde_json::to_value(
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::PrepareCanisterMigration => serde_json::to_value(
                                &(Decode!(a.payload.as_slice(), PrepareCanisterMigrationPayload)?),
                            )?,
                            ic_nns_governance::pb::v1::NnsFunction::CompleteCanisterMigration => serde_json::to_value(
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::UpdateNodesHostosVersion => serde_json::to_value(
                            ...
                            ic_nns_governance::pb::v1::NnsFunction::DeployHostosToSomeNodes => serde_json::to_value(
                                &(Decode!(a.payload.as_slice(), UpdateNodesHostosVersionPayload)?),
                            )?,
