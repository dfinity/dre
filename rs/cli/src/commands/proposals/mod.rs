...
use ic_nns_governance_api::pb::v1::{ProposalInfo, ProposalStatus, Topic};
...
impl TryFrom<ProposalInfo> for Proposal {
    ...
    fn try_from(value: ProposalInfo) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            status: ProposalStatus::try_from(value.status)?,
            summary: proposal.summary,
            title: proposal.title.unwrap_or_default(),
            topic: Topic::try_from(value.topic)?,
                ...
                Action::ExecuteNnsFunction(a) => {
                    if a.payload.is_empty() {
                        ...
                        match a.nns_function() {
                            ic_nns_governance_api::pb::v1::NnsFunction::Unspecified => serde_json::to_value(a)?,
                            ic_nns_governance_api::pb::v1::NnsFunction::CreateSubnet => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), CreateSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::AddNodeToSubnet => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddNodesToSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::NnsCanisterInstall => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddCanisterRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::NnsCanisterUpgrade => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), ChangeCanisterRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::BlessReplicaVersion => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), BlessReplicaVersionPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RecoverSubnet => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RecoverSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateConfigOfSubnet => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::AssignNoid => {
                            ...
                            ic_nns_governance_api::pb::v1::NnsFunction::NnsRootUpgrade => serde_json::json!({}),
                            ic_nns_governance_api::pb::v1::NnsFunction::IcpXdrConversionRate => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateIcpXdrConversionRatePayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::DeployGuestosToAllSubnetNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), DeployGuestosToAllSubnetNodesPayload)?)?
                            }
                            // Has an empty payload
                            ic_nns_governance_api::pb::v1::NnsFunction::ClearProvisionalWhitelist => serde_json::json!({}),
                            ic_nns_governance_api::pb::v1::NnsFunction::RemoveNodesFromSubnet => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RemoveNodesFromSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::SetAuthorizedSubnetworks => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), SetAuthorizedSubnetworkListArgs)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::SetFirewallConfig => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), SetFirewallConfigPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateNodeOperatorConfig => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateNodeOperatorConfigPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::StopOrStartNnsCanister => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), StopOrStartCanisterRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RemoveNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RemoveNodesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UninstallCode => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), CanisterIdRecord)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateNodeRewardsTable => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateNodeRewardsTableProposalPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::AddOrRemoveDataCenters => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddOrRemoveDataCentersProposalPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateUnassignedNodesConfig => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateUnassignedNodesConfigPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RemoveNodeOperators => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RemoveNodeOperatorsPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RerouteCanisterRanges => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RerouteCanisterRangesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::AddFirewallRules => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddFirewallRulesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RemoveFirewallRules => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RemoveFirewallRulesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateFirewallRules => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateFirewallRulesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::PrepareCanisterMigration => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), PrepareCanisterMigrationPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::CompleteCanisterMigration => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), CompleteCanisterMigrationPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::AddSnsWasm => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddWasmRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::ChangeSubnetMembership => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), ChangeSubnetMembershipPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateSubnetType => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::ChangeSubnetTypeAssignment => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateSubnetPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateSnsWasmSnsSubnetIds => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateSnsSubnetListRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateAllowedPrincipals => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateAllowedPrincipalsRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RetireReplicaVersion => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RetireReplicaVersionPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::InsertSnsWasmUpgradePathEntries => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), InsertUpgradePathEntriesRequest)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::ReviseElectedGuestosVersions => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), ReviseElectedGuestosVersionsPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::BitcoinSetConfig => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), BitcoinSetConfigProposal)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateElectedHostosVersions => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateElectedHostosVersionsPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateNodesHostosVersion => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateNodesHostosVersionPayload)?)?
                            }
                            // Unable to resolve rustls deps when adding `ic-nns-test-utils`
                            ic_nns_governance_api::pb::v1::NnsFunction::HardResetNnsRootToVersion => serde_json::json!({}),
                            ic_nns_governance_api::pb::v1::NnsFunction::AddApiBoundaryNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), AddApiBoundaryNodesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::RemoveApiBoundaryNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), RemoveApiBoundaryNodesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateApiBoundaryNodesVersion => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateApiBoundaryNodesVersionPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::DeployGuestosToSomeApiBoundaryNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateApiBoundaryNodesVersionPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::DeployGuestosToAllUnassignedNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), DeployGuestosToAllUnassignedNodesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::UpdateSshReadonlyAccessForAllUnassignedNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateSshReadOnlyAccessForAllUnassignedNodesPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::ReviseElectedHostosVersions => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateElectedHostosVersionsPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::DeployHostosToSomeNodes => {
                                serde_json::to_value(Decode!(a.payload.as_slice(), UpdateNodesHostosVersionPayload)?)?
                            }
                            ic_nns_governance_api::pb::v1::NnsFunction::SubnetRentalRequest => {
