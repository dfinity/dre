...
use crate::{
    ...
    ic_admin::{IcAdminProposal, IcAdminProposalCommand, IcAdminProposalOptions, ProposableViaIcAdmin, ProposalExecutor, ProposalResponse},
};
...
impl FromStr for FirewallTestResult {
...
impl ProposableViaIcAdmin for FirewallTestCommand {
...
impl ProposableViaIcAdmin for FirewallModifyCommand {
...
impl Firewall {
    async fn create_proposal(
        ...
        ForumEnabledProposalExecutor::from_executor_and_mode(forum_parameters, mode, executor)
            .propose(
                FirewallModifyCommand {
                    test_command,
                    hash,
                    summary,
                    title,
