...
//         match maybe_version {
//             Some(version) => Ok(Self{from: None, to: None}),
//                 // if version == 0 {
//                 //     anyhow::bail!("Version 0 is not supported");
//                 // }
//                 // Handle relative version numbers
//                 // if version < 0 {
//                     // if version * -1 > versions_in_registry.len() {
//                     //     anyhow::bail!("Relative version number {} is out of range ({} to {})", version, versions_in_registry[0], versions_in_registry[-1]);
//                     // }
//                     // match mode {
//                     //     VersionFillMode::FromStart => {
//                     //         Self { from: Some(versions_in_registry[1]), to: Some(versions_in_registry[version]) }
//                     //     }
//                     //     VersionFillMode::ToEnd => {
//                     //         Self { from: Some(versions_in_registry[version]), to: Some(versions_in_registry[-1]) }
//                     //     }
//                     // }
//                 // }
//                 // if version > versions_in_registry.len() {
//                 //     anyhow::bail!("Version {} is out of range", version);
//                 // }
//                 // Ok(Self { from: Some(version), to: None })
//             // }
//             None => Ok(Self { from: None, to: None }),
//         }
//     }
