...
# Example:
#
# ./ip6calc.py --prefix "2607:f1d0:10:1" --serial 59HBR53 --deployment-name "mercury"
#
import argparse
import ipaddress
import logging
...
def ipv6_address_calculate_slaac(
    ipv6_prefix: str,
    ipv6_subnet: str,
    serial: str,
    deployment_name: str,
    ...
    mac_address = ansible_random_mac("52:00", f"{serial} {deployment_name} {node_index}")
...
def main():
    ...
    parser.add_argument(
        "--serial",
        action="store",
        help="Serial number of machine hardware",
    )
    ...
    print(ipv6_address_calculate_slaac(args.prefix, "/64", args.serial, args.deployment_name, "1"))
