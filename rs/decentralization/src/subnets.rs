...
use ic_management_types::{requests::{NodeRemoval, NodeRemovalReason}, Status, Subnet};
...
impl NodesRemover {
    pub fn remove_nodes(&self, 
        ...
        nodes_with_proposals: std::collections::BTreeMap<ic_base_types::PrincipalId, ic_management_types::Node>) -> (Vec<NodeRemoval>, String) {
