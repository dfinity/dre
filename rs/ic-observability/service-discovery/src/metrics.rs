...
impl Metrics {
    pub fn new(metrics_registry: MetricsRegistry) -> Self {
        Self {
            poll_count: metrics_registry.int_counter_vec("discovery_poll_count", "Count of successful poll iterations.", &[POLL_STATUS]),
            ...
            total_targets: metrics_registry.int_gauge_vec("total_targets", "total targets found by service discovery", &[JOB_TYPE]),
        }
    }
}
