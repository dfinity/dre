...
* ~~author: dani      | [`a89a2e17c`](https://github.com/dfinity/ic/commit/a89a2e17c) Interface(nns): Metrics for public neurons. ([#685](https://github.com/dfinity/ic/pull/685)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
* ~~author: dani      | [`448c85ccc`](https://github.com/dfinity/ic/commit/448c85ccc) Interface(nns): Added include_public_neurons_in_full_neurons to ListNeurons. ([#589](https://github.com/dfinity/ic/pull/589)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
* ~~author: jaso      | [`2b109fb9b`](https://github.com/dfinity/ic/commit/2b109fb9b) Interface(nns): Define update_canister_settings proposal type without execution ([#529](https://github.com/dfinity/ic/pull/529)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
## Bugfixes:
...
* ~~author: r-bi      | [`d5a950484`](https://github.com/dfinity/ic/commit/d5a950484) Interface(ic-boundary): switch logging setup from eager to lazy eval ([#658](https://github.com/dfinity/ic/pull/658)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
* ~~author: Andr Popo | [`395c0e49a`](https://github.com/dfinity/ic/commit/395c0e49a) Interface(sns): Enforce a minimum on the maximum number of permissioned principals an SNS neuron is allowed to have ([#649](https://github.com/dfinity/ic/pull/649)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
...
* ~~author: Andr Popo | [`96bc27800`](https://github.com/dfinity/ic/commit/96bc27800) Interface(sns): Add controller and hotkeys information to ClaimSwapNeuronsRequest, and use it in SNS Governance ([#596](https://github.com/dfinity/ic/pull/596)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
* ~~author: Andr Popo | [`1a0c97fe4`](https://github.com/dfinity/ic/commit/1a0c97fe4) Interface(sns): Remove the open method from swap. [override-didc-check] ([#454](https://github.com/dfinity/ic/pull/454)) [AUTO-EXCLUDED:Changed files are exluded by file path filter]~~
