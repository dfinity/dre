...
class NodeMetrics:
    """A simple client for querying the IC Metrics canister."""

    def __init__(self):
        """Create a new GovernanceCanister client."""
        self.agent = Agent(Identity(anonymous=True), Client("https://ic0.app"))
        self.principal = "oqi72-gaaaa-aaaam-ac2pq-cai"
        self.canister = None
